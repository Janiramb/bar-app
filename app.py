...
st.markdown(f"""
    ...
    /* Estilo para TODOS los botones (incluidos formularios de Alex) */
...
# --- PANTALLA 2: MENU ALEX ---
    ...
    st.divider()
    st.subheader("🌟 Días Estrella")
    with st.expander("Añadir día especial (Diferente al contrato base)"):
        with st.form("f_esp"):
